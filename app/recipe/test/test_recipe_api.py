...
class PublicRecipeApiTest(TestCase):
    """Test unauthennticated recipe API access"""
...
class RecipeImageUploadTest(TestCase):
    ...
    def setUp(self):
        self.client = APIClient()
        self.user = get_user_model().objects.create_user( 'user@kdap.com', 'testpass')
        self.client.force_authenticate(self.user)
    ...
    def test_filter_recipes_by_tags(self):
        """Test returning recipes with specifies tags"""
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe3 = sample_recipe(user=self.user, title='Fish and chips with tomato')
